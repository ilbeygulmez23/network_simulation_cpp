...
ApplicationLayerPacket::ApplicationLayerPacket(int _layer_ID, const string &_sender_ID, const string &_receiver_ID, const string& _message_data) : Packet(_layer_ID = 0) {
...
void ApplicationLayerPacket::print() {
    ...
    std::cout << "Sender ID: " << sender_ID << ", Receiver ID: "
